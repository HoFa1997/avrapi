 ...
 *                  description: created
 */
router.post("/add", uploadFile.single("image"), stringToArray.stringToArray("tags"), AdminBlogController.createBlog)
/**
 * @swagger
 ...
 *                  description: success
 */
router.patch("/update/:id", uploadFile.single("image"), stringToArray.stringToArray("tags"), AdminBlogController.updateBlogById)
/**
 * @swagger
 *  /admin/blogs/{id}:
 *      get:
